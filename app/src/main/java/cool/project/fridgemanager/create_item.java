...
public class create_item extends AppCompatActivity {
    ...
    protected static final String CLOUD_VISION_API_KEY = "AIzaSyDAM-xyWFAFVz5GtsuZAp6GCIUHKs6l0ws";
    ...
    protected static final int MAX_LABEL_RESULTS = 10;
    protected static final int MAX_DIMENSION = 1200;

    protected static final String TAG = create_item.class.getSimpleName();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        okayBtn.setOnClickListener(view -> {
            ...
            itemDB.add(name, mBytes, tag, putDate, dueDate);
            finish();
        });
    ...
    protected Vision.Images.Annotate prepareAnnotationRequest(final Bitmap bitmap) throws IOException {
    ...
    protected static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        protected final WeakReference<create_item> mActivityWeakReference;
...
//                imageDetail.setText("The top three result for you: "+textToSet);
    ...
    protected String setDateFormat(int year,int monthOfYear,int dayOfMonth){
